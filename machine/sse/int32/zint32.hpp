...
namespace zacc {
    namespace sse {
        ...
        struct __zint32 : public zval<__m128i, int, 4, 16> {
            typedef zval<__m128i, int, 4, 16> base_t;

            __zint32(__m128 value) : base_t(_mm_cvtps_epi32(value)) {}

            __zint32(__m128d value) : base_t(_mm_cvtpd_epi32(value)) {}

            __zint32(__m128i value) : base_t(value) {}

            __zint32(int value) : base_t(_mm_set1_epi32(value)) {}

            __zint32(int *value) : base_t(_mm_load_si128((__m128i *) value)) {}

            __zint32(int a, int b, int c, int d) : base_t(_mm_set_epi32(a, b, c, d)) {}
        };
        ...
        namespace i32 {
            ...
            using commoni32     = int32_policies::common<zint32>;
            using common        = common_policies::common<zint32>;
        ...
        struct zint32 : public compose<
                ...
                i32::common::print_policy,
                i32::commoni32::extract_policy,
