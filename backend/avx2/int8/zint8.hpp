...
namespace zacc {
    namespace avx2 {
        ...
        struct __zint8 : public zval<__m256i, char, 32, 32> {
            typedef zval<__m256i, char, 16, 16> base_t;

            __zint8(__m256i value) : base_t(value) {}

            __zint8(char value) : base_t(_mm256_set1_epi8(value)) {}

            __zint8(char *value) : base_t(_mm256_load_si256((__m256i *) value)) {}

            __zint16(char... args) : base_t(_mm256_set_epi8(std::forward<char>(args)...)) {}
        };
