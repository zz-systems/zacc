...
namespace zacc {
    namespace avx {
        ...
        struct __zfloat64 : public zval<__m512d, double, 4, 32> {
            typedef zval<__m512d, double, 2, 16> base_t;

            __zfloat64(__m512 value) : base_t(_mm512_cvtps_pd(value)) {}

            __zfloat64(__m512d value) : base_t(value) {}

            __zfloat64(__m512i value) : base_t(_mm512_cvtepi32_pd(value)) {}

            __zfloat64(double value) : base_t(_mm512_set1_pd(value)) {}

            __zfloat64(double *value) : base_t(_mm512_load_pd(value)) {}

            __zfloat64(double a, double b) : base_t(_mm512_set_pd(a, b)) {}
        };
